...
if __name__ == "__main__":
    # - dataset “Població – pad_mdbas” on the Barcelona Open-Data portal
    dataset_id   = "pad_mdbas"          
    output_dir   = Path("data/population/raw")

    filter_years = range(2019, 2022)    # 2019, 2020, 2021
